...
The project is licensed `GPL-3.0-only`; published `v0.1.0` archives are intentionally unsigned and
rely on checksums, SPDX SBOMs, and GitHub artifact attestations for artifact identity and provenance.
